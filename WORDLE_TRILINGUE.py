...
bbdd1k = (r"BBDD\PALABRAS_WORDLE_1K")
bbdd10k = (r"BBDD\PALABRAS_WORDLE_10K")
...
def cambiarIdioma():
    if entry_f1_c1.get() == "":
        ...
        if idiomaActual == "Español":
            ...
            bbdd1k = (r"BBDD\PARAULES_WORDLE_1K")
            bbdd10k = (r"BBDD\PARAULES_WORDLE_10K")
            palabraElejida = palabraElejida2
        elif idiomaActual == "English":
            buttonIdioma.configure(text = "EN")
            bbdd1k = (r"BBDD\WORDS_WORDLE_1K")
            bbdd10k = (r"BBDD\WORDS_WORDLE_10K")
            palabraElejida = palabraElejida3


def elegir_palabra_aleatoria():
    miConexion1 = connect(r"BBDD\PALABRAS_WORDLE_1K")
    ...
    miConexion2 = connect(r"BBDD\PARAULES_WORDLE_1K")
    ...
    miConexion3 = connect(r"BBDD\WORDS_WORDLE_1K")
